...
public class BarsException extends Exception{
		...
		public static final String NO_SUPPORTED_FILE = "No supported request file found in the path file";
		...
		public static  final String NO_RECORDS_TO_WRITE = "No record(s) to write from the input file.";
